...
@NgModule({
	declarations: [AnimalListPageComponent, AnimalListCardComponent, AnimalUnitPageComponent, PetsFilterComponent],
	imports: [CommonModule, MatCardModule, MatButtonModule, PetsRoutingModule,MatSelectModule,FormsModule],
